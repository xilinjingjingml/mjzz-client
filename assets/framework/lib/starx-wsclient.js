 ...
 */
  ...
  var connect = function (params, url, cb) {
    ...
    var onopen = function (event) {
      console.log('socket onopen: ', JSON.stringify(event));
      if (!!reconnect) {
    ...
    if (wssCacert && wssCacert.nativeUrl && wssCacert.nativeUrl.length > 0) {
      console.log("wssCacert.nativeUrl = ", wssCacert.nativeUrl)
      socket = new WebSocket(url, [], wssCacert.nativeUrl);
    } else {
